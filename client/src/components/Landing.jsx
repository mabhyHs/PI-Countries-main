...
export default function LandingPage() {
  return (
    <div id="video-lightbox" style={{ display: "block", opacity: "1", zIndex: "100000" }} >
      <div className="popup">
        <div className="image_of_logo">
          <div className="box">
            <div className="box__face box__face--front">
              <img src={backbox} className="front-on" alt="front of the box" />
        ...
        <Link to="/countries">
          <button className="power-btn" title="ingresar al sitio">
            Start
          </button>
        </Link>
